...
export class ProfileService {
  ...
  update(profile: IProfile): Observable<EntityResponseType> {
    return this.http.put<IProfile>(`${this.resourceUrl}/${getProfileIdentifier(profile) as number}`, profile, { observe: 'response' });
  }

  partialUpdate(profile: IProfile): Observable<EntityResponseType> {
    return this.http.patch<IProfile>(`${this.resourceUrl}/${getProfileIdentifier(profile) as number}`, profile, { observe: 'response' });
  }
