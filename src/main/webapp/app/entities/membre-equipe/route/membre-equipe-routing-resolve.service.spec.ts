...
describe('MembreEquipe routing resolve service', () => {
  ...
  let resultMembreEquipe: IMembreEquipe | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IMembreEquipe if id is not provided', () => {
      // GIVEN
      ...
      expect(resultMembreEquipe).toEqual(new MembreEquipe());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as MembreEquipe })));
      mockActivatedRouteSnapshot.params = { id: 123 };
