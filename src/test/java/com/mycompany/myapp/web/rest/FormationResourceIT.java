...
class FormationResourceIT {
    ...
    private static final Integer DEFAULT_NB_ANNEE = 1;
    private static final Integer UPDATED_NB_ANNEE = 2;
    ...
    public static Formation createEntity(EntityManager em) {
        Formation formation = new Formation().nom(DEFAULT_NOM).niveau(DEFAULT_NIVEAU).nbAnnee(DEFAULT_NB_ANNEE).rang(DEFAULT_RANG);
        return formation;
    }
    ...
    public static Formation createUpdatedEntity(EntityManager em) {
        Formation formation = new Formation().nom(UPDATED_NOM).niveau(UPDATED_NIVEAU).nbAnnee(UPDATED_NB_ANNEE).rang(UPDATED_RANG);
        return formation;
    }
    ...
    void createFormation() throws Exception {
        ...
        assertThat(testFormation.getNbAnnee()).isEqualTo(DEFAULT_NB_ANNEE);
        assertThat(testFormation.getRang()).isEqualTo(DEFAULT_RANG);
    }
    ...
    void getAllFormations() throws Exception {
        ...
        restFormationMockMvc
            ...
            .andExpect(jsonPath("$.[*].nbAnnee").value(hasItem(DEFAULT_NB_ANNEE)))
    ...
    void getFormation() throws Exception {
        ...
        restFormationMockMvc
            ...
            .andExpect(jsonPath("$.nbAnnee").value(DEFAULT_NB_ANNEE))
    ...
    void putNewFormation() throws Exception {
        ...
        updatedFormation.nom(UPDATED_NOM).niveau(UPDATED_NIVEAU).nbAnnee(UPDATED_NB_ANNEE).rang(UPDATED_RANG);
        ...
        assertThat(testFormation.getNbAnnee()).isEqualTo(UPDATED_NB_ANNEE);
        assertThat(testFormation.getRang()).isEqualTo(UPDATED_RANG);
    }
    ...
    void fullUpdateFormationWithPatch() throws Exception {
        ...
        partialUpdatedFormation.nom(UPDATED_NOM).niveau(UPDATED_NIVEAU).nbAnnee(UPDATED_NB_ANNEE).rang(UPDATED_RANG);
